...
class ParseSumExprTest {
    ...
    public static Stream<Arguments> sumExprArgs2() {
        return Stream.of(
            Arguments.of("5 + (1 + 11)", "['[SUM_PLUS:+]'=[[NUMBER:5], " +
                "['[SUM_PLUS:+]'=[[NUMBER:1], [NUMBER:11]]]]]"),
            Arguments.of("5 - (2 - 12)", "['[SUM_MINUS:-]'=[[NUMBER:5], " +
                "['[SUM_MINUS:-]'=[[NUMBER:2], [NUMBER:12]]]]]"),
            Arguments.of("5 * (3 * 13)", "['[SUM_MULT:*]'=[[NUMBER:5], " +
                "['[SUM_MULT:*]'=[[NUMBER:3], [NUMBER:13]]]]]"),
            Arguments.of("5 / (4 / 14)", "['[SUM_DIV:/]'=[[NUMBER:5], " +
                "['[SUM_DIV:/]'=[[NUMBER:4], [NUMBER:14]]]]]"),
            Arguments.of("(5 + 1) + 11", "['[SUM_PLUS:+]'=[['[SUM_PLUS:+]'=[[NUMBER:5], [NUMBER:1]]], " +
                "[NUMBER:11]]]"),
            Arguments.of("(5 - 2) - 12", "['[SUM_MINUS:-]'=[['[SUM_MINUS:-]'=[[NUMBER:5], [NUMBER:2]]], " +
                "[NUMBER:12]]]"),
            Arguments.of("(5 * 3) * 13", "['[SUM_MULT:*]'=[['[SUM_MULT:*]'=[[NUMBER:5], [NUMBER:3]]], " +
                "[NUMBER:13]]]"),
            Arguments.of("(5 / 4) / 14", "['[SUM_DIV:/]'=[['[SUM_DIV:/]'=[[NUMBER:5], [NUMBER:4]]], " +
                "[NUMBER:14]]]"),
            Arguments.of("99.99", "[NUMBER:99.99]")
        );
    }
